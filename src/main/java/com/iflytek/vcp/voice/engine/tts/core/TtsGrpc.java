...
public final class TtsGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<TtsOuterClass.TtsRequest,
            TtsOuterClass.TtsResult> getCreateRecMethod;

    @io.grpc.stub.annotations.RpcMethod(
            fullMethodName = SERVICE_NAME + '/' + "createRec",
            requestType = TtsOuterClass.TtsRequest.class,
            responseType = TtsOuterClass.TtsResult.class,
            methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
    public static io.grpc.MethodDescriptor<TtsOuterClass.TtsRequest,
            TtsOuterClass.TtsResult> getCreateRecMethod() {
        io.grpc.MethodDescriptor<TtsOuterClass.TtsRequest, TtsOuterClass.TtsResult> getCreateRecMethod;
            ...
            synchronized (TtsGrpc.class) {
                if ((getCreateRecMethod = TtsGrpc.getCreateRecMethod) == null) {
                    TtsGrpc.getCreateRecMethod = getCreateRecMethod =
                            io.grpc.MethodDescriptor.<TtsOuterClass.TtsRequest, TtsOuterClass.TtsResult>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
                                    .setFullMethodName(generateFullMethodName(
                                            "tts.Tts", "createRec"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            TtsOuterClass.TtsRequest.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            TtsOuterClass.TtsResult.getDefaultInstance()))
    ...
    public static abstract class TtsImplBase implements io.grpc.BindableService {
         ...
         *
         */
        public io.grpc.stub.StreamObserver<TtsOuterClass.TtsRequest> createRec(
                io.grpc.stub.StreamObserver<TtsOuterClass.TtsResult> responseObserver) {
            ...
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            asyncBidiStreamingCall(
                                    new MethodHandlers<
                                            TtsOuterClass.TtsRequest,
                                            TtsOuterClass.TtsResult>(
    ...
    private static abstract class TtsBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return TtsOuterClass.getDescriptor();
        }
